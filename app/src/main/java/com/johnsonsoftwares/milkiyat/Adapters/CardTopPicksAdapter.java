...
public class CardTopPicksAdapter extends RecyclerView.Adapter<CardTopPicksAdapter.ViewHolder> {

   private List<Items> itemsList;
    Context mContext;

    public CardTopPicksAdapter(List<Items> itemsList, Context mContext) {
